...
export const translations = {
  fr: {
    ...
    config: {
      ...
      nextQuote: '→ prochain: {num}/AD/jf',
      aiLimit: 'Limite requêtes Astra AI Pro / jour',
      reqPerDay: 'req/jour',
      aiCascade: '⚡ Cascade IA configurée',
      aiPrimary: 'Primaire: Astra AI Pro (1500/j)',
  ...
  en: {
    ...
    config: {
      ...
      nextQuote: '→ next: {num}/AD/jf',
      aiLimit: 'Astra AI Pro daily limit',
      reqPerDay: 'req/day',
      aiCascade: '⚡ AI Cascade configured',
      aiPrimary: 'Primary: Astra AI Pro (1500/d)',
